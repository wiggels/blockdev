...
## [0.6.2](https://github.com/wiggels/blockdev/compare/v0.6.1...v0.6.2) - 2026-09-04

### Bench

- Publish a calibration normalized series next to the raw one
...
- Clippy assigning_clones on the model trim
- Trim the space padded model string from ID_MODEL_ENC
